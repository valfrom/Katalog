...
func _build_gallery() -> void:
        ...
        portrait_size.y = viewport_height * 0.6
        ...
        for hero in GameManager.HERO_ROSTER:
                ...
                background.position = -portrait_size / 2.0
                background.color = hero.get("color", Color.WHITE)
                ...
                portrait.modulate = Color(0.3, 0.3, 0.3) if !unlocked else Color.WHITE
